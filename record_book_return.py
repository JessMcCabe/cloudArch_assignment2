...
# The book is returned by a customer so a record is removed on the books_on_loan table
...
booksOnLoanHistoryTable = dynamodb.Table('books_on_loan_history');
      ...
      # Show the row in the debug log
       ...
       try:
        # Insert Store, Item and Count into the Inventory table
         ...
         booksOnLoanHistoryTable.put_item(
            Item={
              'ISBN':  row['ISBN'],
              'cust_id':   row['cust_id'],
              'return_date':  row['return_date']
